...
public class Property {
	public static void main(String[] args) {
		...
		Double MaxValProperty3BHK = csvData.stream().parallel().skip(1).filter((row) -> row.get(12).contains("TWO-FAM DWELLING"))
				.mapToDouble((data) -> Double.parseDouble(data.get(29))).max().getAsDouble();
		Double MinValProperty3BHK = csvData.stream().parallel().skip(1).filter((row) -> row.get(12).contains("TWO-FAM DWELLING"))
				.mapToDouble((data) -> Double.parseDouble(data.get(29))).min().getAsDouble();
		Double AvgValProperty3BHK = csvData.stream().parallel().skip(1).filter((row) -> row.get(12).contains("TWO-FAM DWELLING"))
		...
		Double MaxValPropertyPrincetonST = csvData.stream().parallel().skip(1).filter((row) -> row.get(4).contains("PRINCETON ST"))
				.mapToDouble((data) -> Double.parseDouble(data.get(29))).max().getAsDouble();
		Double MinValPropertyPrincetonST = csvData.stream().parallel().skip(1).filter((row) -> row.get(4).contains("PRINCETON ST"))
				.mapToDouble((data) -> Double.parseDouble(data.get(29))).min().getAsDouble();
		Double AvgValPropertyPrincetonST = csvData.stream().parallel().skip(1).filter((row) -> row.get(4).contains("PRINCETON ST"))
				.mapToDouble((data) -> Double.parseDouble(data.get(29))).average().getAsDouble();
		...
		Double MaxValPropertyInMattapan = csvData.stream().parallel().skip(1).filter((row) -> row.get(6).contains("MATTAPAN"))
				.mapToDouble((data) -> Double.parseDouble(data.get(29))).max().getAsDouble();
		Double MinValPropertyInMattapan = csvData.stream().parallel().skip(1).filter((row) -> row.get(6).contains("MATTAPAN"))
				.mapToDouble((data) -> Double.parseDouble(data.get(29))).min().getAsDouble();
		Double AvgValPropertyInMattapan = csvData.stream().parallel().skip(1).filter((row) -> row.get(6).contains("MATTAPAN"))
				.mapToDouble((data) -> Double.parseDouble(data.get(29))).average().getAsDouble();
